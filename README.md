-- ============================================================
-- EDSON MODZ V8 - ULTIMATE CUSTOM EDITION (SWITCH UPDATE)
-- DESIGN ULTRA-PROFISSIONAL | SKELETON ESP | AIMBOT UNIVERSAL
-- 100% PERSONALIZADO POR EDSON | SPEED & NOCLIP SWITCHES
-- ============================================================
...
-- EFEITO RAINBOW REAL E REMOÇÃO TOTAL DE RAYFIELD (LOADING E INTERFACE)
task.spawn(function()
    while task.wait() do
        pcall(function()
            ...
            if MainUI then
                ...
                for _, textLabel in pairs(MainUI:GetDescendants()) do
                    if textLabel:IsA("TextLabel") then
                        if textLabel.Text:find("Rayfield UI") or textLabel.Text:find("Rayfield") then
                            textLabel.Text = textLabel.Text:gsub("Rayfield UI", "EDSON"):gsub("Rayfield", "EDSON")
                        end
...
EDSON_LIB:Notify({
    Title = "EDSON MODZ V8",
    Content = "Bem-vindo, EDSON! Switches de elite ativados.",
    Duration = 5,
    Image = "check-circle",
})
-- ============================================================
